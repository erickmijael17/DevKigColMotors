          ...
          <?php if(Route::has('login')): ?>
            <nav class="d-flex">
                <?php if(auth()->guard()->check()): ?>
                    <a class="cta-btn" href="<?php echo e(url('/dashboard')); ?>">Dashboard</a>
                <?php else: ?>
                    <a class="cta-btn" href="<?php echo e(route('login')); ?>">Log in</a>
                    <?php if(Route::has('register')): ?>
                        <a class="cta-btn" href="<?php echo e(route('register')); ?>">Register</a>
                    <?php endif; ?>
                <?php endif; ?>
            </nav>
        <?php endif; ?>
...
<?php /**PATH D:\LARAVEL\ronko\resources\views/welcome.blade.php ENDPATH**/ ?>